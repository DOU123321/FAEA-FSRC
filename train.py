...
def main():
    ...
    parser.add_argument('--model', default='FAEA',
                        help='model name')
    ...
    parser.add_argument('--hidden_size', default=768, type=int,
                        help='hidden size')
    parser.add_argument('--load_ckpt', default='./checkpoint/FAEA-bert-train_wiki-val_wiki-10-1.pth.tar',
                        help='load ckpt')
    ...
    model = FAEA(sentence_encoder, hidden_size=opt.hidden_size, max_len=max_length)
